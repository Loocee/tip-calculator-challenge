...
function calculator() {
  tipPerPersonValue = Math.round(((billValue * percentageNumber) / 100) / noOfPeopleValue);
  totalPerPersonValue = Math.round((billValue / noOfPeopleValue) + (((billValue * percentageNumber) / 100) / noOfPeopleValue));
  output();
}
